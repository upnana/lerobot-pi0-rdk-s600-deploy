...
> 状态：SigLIP 正品 + **正式 PaliGemma** 已出（[11](./11-paligemma-formal.md)）；临时 Expert 仍垫脚；下一步 dump KV → 正式 Expert。
...
| PaliGemma | `paligemma/` | **正式已出**（`precomputed_s600_siglip_hbm`） | [11](./11-paligemma-formal.md) |
