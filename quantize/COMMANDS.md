...
| PaliGemma / Expert HBM | **正式两段均已出** | [11](../docs/11-paligemma-formal.md) / [13](../docs/13-expert-formal.md) |
...
**完整记录（拉回 KV + 正式编译）→ [`docs/13-expert-formal.md`](../docs/13-expert-formal.md)。**
